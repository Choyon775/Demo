      ...
      <div class="container">
        ...
        <div class="row" style="padding-left: 10px;">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="team members/ayon.jpeg"   class="img-fluid "  style=" height: 320px;" alt="">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="team members/Faisal.jpg" style=" height: 320px;" class="img-fluid  " alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Faisal Ahmed</h4>
                </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="team members/choyon.jpg" class="img-fluid  " style=" height: 320px;" alt="">
              <div class="member-info">
                <div class="member-info-content">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6" data-wow-delay="0.1s">
            <div class="member">
              <img src="team members/mehedi.jpg" class="img-fluid " style=" height: 320px;" alt="">
              <div class="member-info">
                <div class="member-info-content">
          ...
          <div class="col-xl-4 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="team members/sadman.jpg" class="img-fluid" style=" height: 320px;" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Sadman Shakib</h4>
                </div>
          ...
          <div class="col-xl-4 col-lg-4 col-md-6" data-wow-delay="0.2s">
            <div class="member">
              <img src="team members/likhon.jpg" class="img-fluid "  style=" height: 320px;" alt="">
              <div class="member-info">
                <div class="member-info-content">
                  <h4>Istiak Tareq</h4>
                </div>
